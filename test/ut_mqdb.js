...
describe('Find By ClientId Check', function () {
    ...
    it('insert nodeMock4', function (done) {
...
describe('exportClientIds', function () {
    it('find all client ids', function (done) {
...
describe('replace', function () {
    it('replace(cId, path, value, callback)', function (done) {
...
describe('modify', function () {
    it('modify(cId, path, snippet, callback)', function (done) {
...
describe('remove', function () {
    it('removeByClientId(cId, callback)', function (done) {
